 ...
 *
 * Sintetizado via WebAudio (sem MP3): zero asset novo (nada entra no precache
 * do service worker) e controle total do envelope pra manter o toque discreto.
...
const INTERVALO_MIN_MS = 3000; // rajada de eventos (ex.: aprovação = order + ledger) = um toque só
...
/** Destrava o áudio num gesto do usuário (autoplay policy; obrigatório no iOS). */
