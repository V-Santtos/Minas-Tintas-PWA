  ...
  const ROWS = [
    {
      icon: User,
      title: "Meus dados",
      sub: `${data.profile.name} · ${data.profile.phone}`,
      href: "/perfil/meus-dados",
    },
    {
      icon: BarChart2,
      title: "Minha atividade",
      sub: "Pedidos, pontos e clientes",
      href: "/perfil/atividade",
    },
    {
      icon: UserPlus,
      title: "Clientes",
      sub: "Cadastrar e consultar clientes",
      href: "/perfil/clientes",
    },
    {
      icon: Settings,
      title: "Configurações",
      sub: "Notificações e programa",
    ...
    <>
      <div className="topbar" style={{ paddingBottom: 20 }}>
        <div className="eyebrow-label">
          PINTOR PARCEIRO DESDE {data.profile.parceiroDesde}
        </div>
          ...
          return (
            ...
            >
              <div className="profile-icon">
                <Ico size={18} strokeWidth={1.75} color="var(--ink)" />
              </div>
              <div>
                <div
