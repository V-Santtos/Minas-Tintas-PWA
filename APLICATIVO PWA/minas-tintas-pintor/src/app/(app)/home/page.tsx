...
import { ptsFmt, brl, bonusPts } from "@/lib/pintor-data";
...
export default function HomePage() {
  ...
  const quickRewards = [...data.loja]
    ...
    .map((p) => ({
      ...
      pts: p.pts,
      promo: p.promo,
      near: p.pts > saldo && p.pts <= saldo * 1.5,
    }));
  const resgateState: "low" | "high" = quickRewards.some((p) => p.pts <= saldo)
    ? "high"
    : "low";
    ...
    <>
      ...
      >
        <div>
          <div className="eyebrow-label">
            OLÁ, {data.profile.firstName.toUpperCase()}
          </div>
      ...
      <div
        style={{
          ...
          boxShadow: "0 2px 6px rgba(28,26,23,.05)",
        }}
      >
        <div
          style={{
        ...
        >
          <span className="eyebrow-label" style={{ margin: 0 }}>
            SALDO MINAS TINTAS
          </span>
          <div
            style={{
      ...
      >
        {quickRewards.map((p, i) => (
          <Link
            ...
            style={{ minWidth: 148, maxWidth: 148, flexShrink: 0 }}
          >
            {p.promo ? (
              <div
                style={{
            ...
            <div className="reward-thumb">
              {p.img ? (
                ...
                (() => {
                  ...
                  return (
                    <Ico size={28} strokeWidth={1.4} color="var(--muted)" />
                  );
                })()
              )}
            </div>
