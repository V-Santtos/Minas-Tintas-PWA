...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div
        ...
        style={{
          flex: '0 0 45%',
          backgroundImage: "linear-gradient(rgba(43,39,39,.55), rgba(43,39,39,.55)), url('/assets/bg-de-fundo.png')",
      ...
      >
        ...
        <div style={{ position: 'absolute', bottom: 28, left: 28, zIndex: 10 }}>
          <div style={{ width: 24, height: 1, background: 'rgba(255,255,255,.18)', marginBottom: 8 }} />
          <div style={{
            fontSize: 10,
            fontWeight: 700,
      ...
      <div
        ...
        style={{ background: 'var(--paper)', padding: 'clamp(32px, 5vw, 80px) clamp(32px, 6vw, 96px)' }}
      >
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <div style={{ width: 40, height: 3, background: '#373131', borderRadius: 2, marginBottom: 10 }} />

          <p style={{ color: 'var(--muted)', fontSize: 14, lineHeight: 1.6, marginBottom: 36 }}>
            Acesse o painel de gestão<br />da Minas Tintas.
          </p>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{
              ...
              <Mail size={16} color="var(--muted)" strokeWidth={1.75} style={{ flexShrink: 0 }} />
              <input
                type="email"
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            <div style={{
              ...
              <Lock size={16} color="var(--muted)" strokeWidth={1.75} style={{ flexShrink: 0 }} />
              <input
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 6, marginBottom: 32 }}>
            <label style={{ display: 'inline-flex', alignItems: 'center', gap: 9, cursor: 'pointer', userSelect: 'none' }}>
              ...
              />
              <span style={{ fontSize: 12.5, fontWeight: 600, color: '#373131', fontFamily: 'var(--font-body)' }}>
                Lembrar-me
              </span>
            </label>
            ...
            <button style={{
              ...
              fontSize: 12.5, fontWeight: 600, color: '#373131',
