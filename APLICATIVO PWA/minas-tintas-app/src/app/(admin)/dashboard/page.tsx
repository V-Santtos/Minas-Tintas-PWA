...
import { Search, X, User, Building2, HardHat, Phone, UserPlus } from 'lucide-react'
import { CLIENTS, PAINTERS, type Client } from '@/lib/mock'
...
export default function AdminHomePage() {
  ...
  const mockClients = CLIENTS.filter(c => !localNames.has(c.name.toLowerCase()))
  const allClients = [...localClients, ...mockClients]
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 690 }}>
        ...
        <p style={{
          ...
          fontSize: 15, lineHeight: 1.6, marginBottom: 30,
        }}>
        ...
        <div style={{ position: 'relative' }}>
          <div
            style={{
              ...
              borderRadius: 16, padding: '0 18px 0 14px', height: 60,
            ...
            <div style={{ marginTop: 10 }}>
              {results.length === 0 ? (
                <div style={{
                  ...
                  padding: '32px 0 28px', gap: 12,
                }}>
                  <p style={{ color: 'var(--muted)', fontSize: 13.5, textAlign: 'center' }}>
                    Nenhum cliente encontrado para <strong style={{ color: 'var(--ink)' }}>&quot;{query}&quot;</strong>
                  </p>
                  <button
                ...
                <div style={{
                  ...
                  {results.map((c, i) => {
                    const painter = c.painter ? PAINTERS.find(p => p.name === c.painter) : null
                        ...
                        <div style={{ textAlign: 'right', flexShrink: 0 }}>
                          {painter ? (
                            <>
                              <div style={{
                                display: 'inline-flex', alignItems: 'center', gap: 6,
                                background: 'rgba(79,122,74,.1)', color: '#4F7A4A',
